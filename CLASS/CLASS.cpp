...
pair<MatrixXd, VectorXd> CLASS_algorithm(MatrixXd X, VectorXd y, int nsample, int ntimes, int k)
{
...
/*
tuple<MatrixXd, VectorXd, vector<int>> CLASS_algorithm_sim(MatrixXd X, VectorXd y, int nsample, int ntimes, int k)
{
    //0th column is the intercept column
    vector<int> c(X.cols()-1);
    int q=X.cols()-1;
